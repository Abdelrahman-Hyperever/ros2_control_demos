...
hardware_interface::return_type ros2_control_demo_example_16 ::DiffBotSystemHardware::write(
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  // BEGIN: This part here is for exemplary purposes - Please do not copy to your production code
  std::stringstream ss;
...
PLUGINLIB_EXPORT_CLASS(
  ros2_control_demo_example_16::DiffBotSystemHardware, hardware_interface::SystemInterface)
